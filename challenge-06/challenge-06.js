...
*/
// ?
let teams = ['flamengo', 'fluminense', 'botafogo', 'saoPaulo', 'palmeiras']
...
console.log(convertToHex('dark brown'))
console.log(convertToHex('dark blue'))
console.log(convertToHex('light'))