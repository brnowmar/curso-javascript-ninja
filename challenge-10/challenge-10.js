(function () {
    ...
    */
    ...
    deve ser a frase:
    'A operação [x] [OPERATOR] [y] =';
    Essa função mostrará a mensagem da operação que criaremos mais abaixo.
    */
    // ?
    function showOperationMessage(x, operator, y) {
    ...
    */
    ...
    PASSO 1:
    - Declare 3 variáveis: "x" e "y", iniciando com valor zero, e
    ...
    */
    ...
    "false", e então atribua às variáveis "x" e "y", dois números
