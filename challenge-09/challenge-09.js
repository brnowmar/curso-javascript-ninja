...
(function () {
    ...
    */
    ...
    console.log(sum(function (firstNumber, secondNumber) {
    ...
    */
    // ?
    let subtraction = calculator(10, 50);
    let division = calculator(20, 40);
    let mod = calculator(30, 60);
    let multiplication = calculator(100, 240);
    ...
    */
    ...
    // ?
    console.log(subtraction(function (firstNumber, secondNumber) {
        return firstNumber - secondNumber;
    }))
    console.log('O resultado da multiplicação é:');
    // ?
    console.log(multiplication(function (firstNumber, secondNumber) {
        return firstNumber * secondNumber;
    }))

    console.log('O resultado da divisão é:');
    // ?
    console.log(division(function (firstNumber, secondNumber) {
        return firstNumber / secondNumber;
    }))

    console.log('O resto da divisão é:');
    // ?
    console.log(mod(function (firstNumber, secondNumber) {
        return firstNumber % secondNumber;
    }))
}());